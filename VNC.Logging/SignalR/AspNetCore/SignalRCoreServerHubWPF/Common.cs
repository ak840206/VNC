...
namespace SignalRCoreServerHubWPF
{
    public static class Common
    {
        ...
        public const string PROJECT_NAME = "SignalRCoreServerHubWPF";
        public const string LOG_CATEGORY = "SignalRCoreServerHubWPF";

        public const string cCONFIG_FILE = @"C:\temp\SignalRCoreServerHubWPF_Config.xml";
