...
namespace SignalRCoreClientWPF
{
    public static class Common
    {
        ...
        public const string PROJECT_NAME = "SignalRCoreClientWPF";
        public const string LOG_CATEGORY = "SignalRCoreClientHubWPF";

        public const string cCONFIG_FILE = @"C:\temp\SignalRCoreClientWPF_Config.xml";
